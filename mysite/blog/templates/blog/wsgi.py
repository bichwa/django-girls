...
# web application at http://bichwa12.pythonanywhere.com/
...
#import sys
#
#path = '/home/bichwa12/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/bichwa12/mysite/settings.py'
#path = '/home/bichwa12'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
#path = '/home/bichwa12/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
